...
var jbImagesDialog = {
	...
	uploadFinish : function(result) {
		...
		else
		{
			...
			tinyMCEPopup.editor.execCommand('mceInsertContent', false, '<img src="' + result.filename +'" data-original="' + result.filename +'" class="lazy img-responsive" alt="'+result.fileOriginalName+'" '+result.finalSize+'/>');
			tinyMCEPopup.close();
		}
	}
