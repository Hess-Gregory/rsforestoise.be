...
var jbImagesDialog = {
	...
	uploadFinish : function(result) {
		...
		else
		{
			...
			tinymce.EditorManager.activeEditor.insertContent('<img src="' + result.filename +'" data-original="' + result.filename +'" class="lazy img-responsive" alt="'+result.fileOriginalName+'" '+result.finalSize+'/>');
